...
struct ListDirection {
  ...
  ListDirection()
      : south(Direction::Uninitialized), east(Direction::Uninitialized),
        west(Direction::Uninitialized), north(Direction::Uninitialized) {}
...
public:
  Choice() { this->from = Direction::Uninitialized; }
  ...
  Choice(Position _at, Direction _from, ListDirection _pChoices) {
    this->at = _at;
  ...
  bool isDeadend() { return (pChoices.size() == 0); }
